<template>
  <section class="container-section contact" id="contact">
    ...
    <div id="contactscontainer">
      <h2>I'm always looking for the sea and the summer. In the meantime, find me here:</h2>
      ...
      <div id="mycontacts">
          ...
          <figure>
            <span id="codewars">
              <svg
                ...
                viewBox="0 0 24 24"
              >
                <title id="simpleicons-codewars-icon">Codewars icon</title>
                <path
                  class="contactIcons"
                  stroke="#FFF"
          ...
          <figure>
            <span id="github">
              ...
              <svg
                ...
                x="0px"
                y="0px"
                viewBox="228.5 253.5 30 30"
                enable-background="new 228.5 253.5 30 30"
                xml:space="preserve"
              >
                <g>
                  <path
                    class="contactIcons"
                    stroke="#FFF"
                    d="M245.852,274.252c2.923-0.345,6.032-1.408,6.032-6.456c0-1.435-0.505-2.604-1.328-3.508
        ...
        <a href="https://www.facebook.com/marian.vidoe">
          <figure>
            <span id="facebook">
        ...
        <a href="https://github.com/Marianissimus">
          <figure>
            <span id="gitter">
              <svg
                aria-labelledby="simpleicons-gitter-icon"
                role="img"
                viewBox="0 0 24 24"
                xmlns="http://www.w3.org/2000/svg"
              >
                <title id="simpleicons-gitter-icon">Gitter icon</title>
                <path
                  class="contactIcons"
                  stroke="#FFF"
...
export default {
  ...
  var waypoint = new Waypoint({
    element: document.getElementById('contactscontainer'),
    handler: function(direction) {
      if (direction === 'down') {
        ...
        contactIconsDrawing.restart()        
          ...
          let el = document.querySelectorAll(".contactIcons");
          el.forEach(x => x.classList.remove('completed')); 
          el.forEach(x => x.stroke = '')
        }
      }
    })
  },
